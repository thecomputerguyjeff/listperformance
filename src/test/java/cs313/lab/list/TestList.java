...
public class TestList {
  ...
  public void setUp() throws Exception {
    ...
    //all of the tests pass with both the LinkedList and the ArrayList.
  }
  ...
  public void testRemoveObject() {
    ...
    //It removes the object at index 5 and pushes everything past that up.
    // TODO fix the expected values in the assertions below
    ...
    //It removes the first instance of the integer 5 in the list.
    assertEquals(5, list.size());
    assertEquals(1, list.indexOf(77));
    assertEquals(3, list.lastIndexOf(77));
    assertEquals(4, list.get(2).intValue());
    assertEquals(77, list.get(3).intValue());
    assertEquals(6, list.get(4).intValue());//I wrote this test to check something.
